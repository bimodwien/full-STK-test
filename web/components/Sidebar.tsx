...
const Sidebar: React.FC = () => {
  return (
    <aside className="flex h-screen w-72 shrink-0 flex-col gap-6 bg-[#0A4DA8] p-4 text-white md:w-80">
      {/* Top bar */}
      <div className="flex items-center justify-between px-2">
        ...
        <button
          ...
          className="inline-flex h-9 w-9 items-center justify-center rounded-md bg-white/10 text-white ring-1 ring-white/15 transition hover:bg-white/15"
        >
